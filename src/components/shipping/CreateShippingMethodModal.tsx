...
import { Truck, DollarSign, Package, Settings } from "lucide-react";
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="shipping-name">Nom de la méthode *</Label>
                <Input
                  id="shipping-name"
                  value={formData.name}
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="rounded"
                />
                <Label htmlFor="shipping-active">Méthode active</Label>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="shipping-price">
                    Prix ({formatPrice(0, { showSymbol: true, showCode: true })}) *
                  </Label>
                  <Input
                    id="shipping-price"
                    type="number"
                ...
                <div className="space-y-2">
                  <Label htmlFor="shipping-days">Délai estimé</Label>
                  <Input
                    id="shipping-days"
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => handleInputChange("free_shipping_enabled", e.target.checked)}
                    className="rounded"
                  />
                  <Label htmlFor="free-shipping">Activer la livraison gratuite</Label>
                </div>

                {formData.free_shipping_enabled && (
                  <div className="space-y-2">
                    <Label htmlFor="shipping-threshold">Seuil livraison gratuite ({formatPrice(0, { showSymbol: true, showCode: true })})</Label>
                    <Input
                    ...
                    <p className="text-xs text-muted-foreground">
                      Livraison gratuite pour les commandes au-dessus de ce montant
                    </p>
                  </div>
                )}
              </div>
