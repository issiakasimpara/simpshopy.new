-- Script final pour créer la table payments avec les bonnes politiques RLS
...
-- Policy pour les propriétaires de boutique (utilise merchant_id)
...
-- Vérification
SELECT 'Table payments créée avec succès avec les bonnes politiques RLS' as status; 