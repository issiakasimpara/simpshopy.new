-- Migration pour créer les tables d'onboarding et multi-devises
-- Date: 2025-01-28
...
INSERT INTO supported_currencies (code, name, symbol, locale, decimals, exchange_rate_to_usd) VALUES
('XOF', 'Franc CFA (BCEAO)', 'CFA', 'fr-ML', 0, 0.0016),
('XAF', 'Franc CFA (BEAC)', 'FCFA', 'fr-CM', 0, 0.0016),
('GHS', 'Cedi ghanéen', '₵', 'en-GH', 2, 0.083),
('NGN', 'Naira nigérian', '₦', 'en-NG', 2, 0.0011),
('EUR', 'Euro', '€', 'fr-FR', 2, 1.09),
('USD', 'Dollar américain', '$', 'en-US', 2, 1.0),
('GBP', 'Livre sterling', '£', 'en-GB', 2, 1.27),
('JPY', 'Yen japonais', '¥', 'ja-JP', 0, 0.0067),
('CAD', 'Dollar canadien', 'C$', 'en-CA', 2, 0.74),
('AUD', 'Dollar australien', 'A$', 'en-AU', 2, 0.66),
('CHF', 'Franc suisse', 'CHF', 'de-CH', 2, 1.17),
('CNY', 'Yuan chinois', '¥', 'zh-CN', 2, 0.14),
('INR', 'Roupie indienne', '₹', 'en-IN', 2, 0.012),
('BRL', 'Real brésilien', 'R$', 'pt-BR', 2, 0.21),
('MXN', 'Peso mexicain', '$', 'es-MX', 2, 0.059),
('ZAR', 'Rand sud-africain', 'R', 'en-ZA', 2, 0.054),
('EGP', 'Livre égyptienne', 'E£', 'ar-EG', 2, 0.032),
('KES', 'Shilling kényan', 'KSh', 'en-KE', 2, 0.0068),
('UGX', 'Shilling ougandais', 'USh', 'en-UG', 0, 0.00027),
('TZS', 'Shilling tanzanien', 'TSh', 'sw-TZ', 0, 0.00043)
